...
file_id_gender = '1TBwLj-v41E2PfojT0tL95LJG_2WqhkHK'
url = f'https://drive.google.com/uc?export=download&id={file_id_gender}'

# Download the file
gdown.download(url, 'gender_predict.pth', quiet=False)
gender_model = torch.load("gender_predict.pth", map_location=device, weights_only=False)
...
file_id_emotion = '1hDutyi6-5gXv8LPfiJSDi3p8-HRJhVQt'
url = f'https://drive.google.com/uc?export=download&id={file_id_emotion}'

# Download the file
gdown.download(url, 'New_emotion_model.h5', quiet=False)
